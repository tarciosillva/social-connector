...
type Repository[T any] interface {
	...
	Update(ctx context.Context, collectionName string, conversation_id string, entity T) (T, error)
	Delete(ctx context.Context, collectionName string, conversation_id string) error
